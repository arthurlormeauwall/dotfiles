...
if [ -r $DOT_FILES/zshconfig/.zshenv ]; then
    source $DOT_FILES/zshconfig/.zshenv
fi
if [ -r $ZSHCONFIG/aliassources.sh ]; then
    source $ZSHCONFIG/aliassources.sh
fi
...
ZSH_CUSTOM=$ZSHCONFIG/oh-my-custom
